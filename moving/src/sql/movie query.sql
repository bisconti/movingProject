...
"액션","조 샐다나,샘 워싱턴","아바타 물의 길","2022-12-14","192분",
...
("액션","다니엘 크레이그,레아 세이두","007 스펙터","2015-11-12","148분",
...
궁지에 몰린 MI6조차 그를 포기하면서 절체절명의 위기에 직면하는데…","2023-01-21","해외","15"),

("액션","크리스 햄스워스,마이클 섀넌","12솔져스","2018-01-31","130분",
"전 세계가 목격한 사상 최악의 테러 발생 15일 후, '미치(크리스 헴스워스)'는 사랑하는 가족을 뒤로 한 채 비공식 작전 수행을 위한
 ...
 그러나 반드시 성공해야만 하는 작전!","2023-02-24","해외","15"),
 
 ("액션","현빈,유해진","공조2 인터네셔널","2022-09-07","129분",
 ...
 각자의 목적으로 뭉친 그들의 짜릿한 공조 수사가 시작된다!","2023-03-31","국내","15"),
 
("액션","라이언 레이놀즈,조슈 브롤린","데드풀2","2018-05-16","117분",
...
새로운 사건이 발생하고 데드풀은 생각지도 못한 기상천외 패밀리를 결성하게 되는데...","2023-06-25","해외","19"),

("액션","마크 월버그,로렌 코핸","마일22","2018-08-23","95분",
...
매버릭은 자신이 가르친 동료들과 함께 마지막이 될 지 모를 하늘 위 비행에 나서는데…","2024-03-30","해외","12"),

("액션","톰 크루즈,헨리 카빌","미션 임파서블 폴아웃","2018-07-25","147분",
"도난당한 핵무기를 되찾아 오는 위험천만한 작전 중, 에단 헌트(톰 크루즈)는 임무를 포기하고, 팀원의 목숨을 구하는 선택을 한다.
 ...
 이보다 더 불가능한 미션은 없었다!
 역대 최대 규모, 최강 액션을 기대하라!","2022-02-23","해외","15"),
 
 ("액션","톰 하디,미셸 월리엄스","베놈","2018-10-03","107분",
 "영웅인가, 악당인가
진실을 위해서라면 몸을 사리지 않는 정의로운 열혈 기자 '에디 브록'
 ...
 지배할 것인가, 지배당할 것인가","2023-01-31","해외","15"),
 
 ("액션","채드윅 보스만,루피타 뇽","블랙팬서","2018-02-14","135분",
 "‘시빌 워’ 이후 와칸다의 왕위를 계승한 티찰라(채드윅 보스만)는
 와칸다에만 존재하는 최강 희귀 금속 ‘비브라늄’과
 왕좌를 노리는 숙적들의 음모가 전세계적인 위협으로 번지자
 세상을 구할 히어로 ‘블랙 팬서’로서 피할 수 없는 전쟁에 나서는데…","2023-02-22","해외","12"),
...
과거의 기억으로 마음을 닫아버린 남자 '루이'
 ...
 눈을 감으면 더욱 선명해지는 얼굴,
 너의 눈이 말하고 있어.","2022-03-11","해외","15"),
 
 ("로맨스","에일리 하보,카야 월킨스","델마","2018-08-15","116분",
 "특별한 사람이 있어요
평범한 대학 신입생 델마는 우연히 아냐를 만난 후 발작으로 쓰러진다
 이후 알 수 없는 힘에 사로잡힌 그녀는
 자신의 놀라운 능력 그리고 가족들이 숨겨온 금기의 과거와 마주하게 되는데…
 WANT HER WAKE HER","2023-01-02","해외","15"),
...
XP(색소성건피증)라는 희귀병으로 태양을 피해야만 하는 케이티.
 ...
 너에게 하고 싶은 진짜 사랑 고백
 태양이 뜬 뒤에도 내 곁에 있어줄래?","2023-02-20","해외","12"),
 
 ("로맨스","테라지마 시노부,조쉬 하트넷","오 루시!","2018-06-28","95분",
 "안녕? 나는 사랑에 빠진 루시라고 해!
친구도, 가족도, 사랑도 없는 외로운 중년 여성 세츠코.
 ...
 세츠코는 과연 진짜 사랑을 붙잡을 수 있을까?","2023-05-31","해외","15"),
...
사랑을 믿지 않는 간호사, 펠리시아
 ...
 각국의 전쟁지로 떠도는 그로 인해
 혼란과 외로움으로 밤을 지새우는데…","2023-04-20","해외","19"),
 
 ("로맨스","여명,왕뤄단","더 시크릿","2016-09-08","100분",
 ...
 사랑하는 아내를 지키려는 카이펑. 그러나 두 사람은 생각지도 못했던 비밀을 마주하게 되는데….","2023-04-02","해외","15"),
 
 ("로맨스","오영산,양조개","내가 처음으로 사랑한 소녀","2022-04-27","95분",
 "“그 시절 사랑했던 너와 나”
12년 내내 여학교를 다니며 학생대표를 해오던 윙(담선언),
 ...
 평생 함께하자던 소울메이트였던 그들,
 그때 너도 나와 같은 마음이었을까?","2023-05-04","해외","15"),
 
 ("로맨스","아비게일 코웬,톰 뤼스","리디밍 러브","2022-03-23","134분",
 "이 사랑이 당신을 꿈꾸게 한다!
누구나 품을 수 있지만, 누구도 소유할 수 없는 ‘엔젤’
 ...
 사랑이 이끄는 순간, 눈부신 기적이 시작된다!","2024-02-11","해외","15"),
 
 ("로맨스","제니퍼 로페즈,오웬 윌슨","메리 미","2022-03-16","112분",
 "선결혼 후연애!
슈퍼스타 X 슈퍼노멀 커플 탄생!
슈퍼스타 ‘캣 발데즈’는 화려한 공개 결혼식 콘서트 당일
 ...
 두 사람의 특별한 선결혼 후연애 로맨스가 지금부터 시작된다!","2024-01-10","해외","12"),
 
 ("로맨스","셀리나제이드,존 플레처","내 사랑 찾기","2020-10-22","84분",
 "“내 진짜 사랑은 어디에 있나요?”
사랑과 관계에 서툰 ‘에이프릴’은
 ...
 짝, 사랑
 환상 속에 그대는 지금 어디에 있나요?","2023-08-31","해외","12"),
...
옛날 어느 먼 옛날, 그레텔과 헨젤은 먹을 것과 일감을 찾기 위해 집을 떠나지만 길을 잃고 만다. 그들은 허기짐에 먹을 것이 풍성하게 차려진 한 오두막에 이끌려 집으로 들어가게 되고, 그 곳에서 집 주인 ‘홀다’를 만난다. 그녀의 배려로 두 남매는 풍족한 음식과 따뜻한 잠자리를 제공받으며 점점 안정을 되찾는다.
 ...
 두 남매를 계속해서 어둠 속으로 몰아넣는데…","2023-07-20","해외","15"),
 
 ("판타지","케이시 애플렉,루니 마라","고스트 스토리","2017-12-28","92분",
 "사랑을 잃다
 교외의 작고 낡은 집 -
 ...
 남겨진 고스트는 영원히 그녀를 기다릴 자신의 운명을 알기에 끝을 알 수 없는 긴 여정을 시작한다","2023-12-20","해외","12"),
...
자신의 특별한 능력을 통해 사람들의 마음 속 슬픔과 갈망을 들여다보는 최면술사 ‘제니아’.
 ...
 '당신의 불행과 고통을 몰아내는 중입니다. 제가 셋을 세면 눈을 뜹니다. 하나, 둘, 셋, 탁!'","2023-11-11","해외","15"),
...
‘필립 왕자’의 결혼 약속으로 인간 세계의 ‘잉그리스 왕비’와 대립하게 된다.
 ...
 등장하면서 두 세계는 피할 수 없는 거대한 전쟁에 휘말리게 되는데…..","2023-01-20","해외","12"),
 
 ("판타지","김윤석,변요한","당신,거기 있어줄래요","2016-12-14","111분",
...
2015년 현재
 ...
 그 때로 돌아간다면… 지금의 내 인생도 바뀔 수 있을까요?","2024-04-02","국내","12"),
...
할아버지의 죽음의 단서를 쫒던 ‘제이크’ 는 시간의 문을 통과해 놀라운 비밀과 마주한다.
 ...
 시간과 공간을 넘나들며 펼쳐지는 이들의 대결이 팀버튼의 마법같은 상상력으로 펼쳐진다.","2023-05-01","해외","12"),
...
택해야 한다. 마침내 다섯 군대의 전투가 시작되고 빌보는 본인과 친구들의 목숨을 걸고 싸워야만 하는데…","2023-02-15","해외","12"),
 
 ("판타지","제니퍼 로렌스,조쉬 허처슨","헝거게임:모킹제이","2014-11-20","123분",
 "캐피톨 VS 13구역 혁명군
...
모킹제이가 되어달라고 부탁하고, 모두의 희망이 된 캣니스는 이제 세상을 구할 반격을 시작한다.","2023-03-20","해외","15"),
...
할로윈이 다가오고 있던 어느 날, 단짝 ‘소니’와 ‘샘’은 으스스한 분위기의 버려진 집을 발견한다.
 ...
 위험에 빠진 가족과 마을을 구할 수 있을까?","2023-06-30","해외","12"),
 
 ("판타지","하정우,주지훈","신과 함께-인과 연","2018-08-01","141분",
 ...
 이승과 저승, 현재와 과거를 오가는 천 년의 비밀이 밝혀진다!","2023-03-09","국내","12"),

("애니메이션",null,"미니언즈2","2022-07-20","87분","세계 최고의 슈퍼 악당을 꿈꾸는 미니보스 ‘그루’와 그를 따라다니는 미니언들. 어느 날 그루는 최고의 악당 조직 ‘빌런6’의 마법 스톤을 훔치는데 성공하지만 뉴페이스 미니언 ‘오토’의 실수로 스톤을 잃어버리고 빌런6에게 납치까지 당한다. 미니보스를 구하기 위해 잃어버린 스톤을 되찾아야 하는 ‘오토’, 그리고 쿵푸를 마스터해야 하는 ‘케빈’, ‘스튜어트’, ‘밥’! 올여름 극장가를 점령할 MCU(미니언즈 시네마틱 유니버스)가 돌아온다!","2023-02-23","해외","0"),
("애니메이션",null,"너의 이름은","2017-01-04","106분","아직 만난 적 없는 너를, 찾고 있어 천년 만에 다가오는 혜성 기적이 시작된다 도쿄에 사는 소년 ‘타키’와 시골에 사는 소녀 ‘미츠하’는 서로의 몸이 뒤바뀌는 신기한 꿈을 꾼다 낯선 가족, 낯선 친구들, 낯선 풍경들... 반복되는 꿈과 흘러가는 시간 속, 마침내 깨닫는다 우리, 서로 뒤바뀐 거야? 절대 만날 리 없는 두 사람 반드시 만나야 하는 운명이 되다 서로에게 남긴 메모를 확인하며 점점 친구가 되어가는 ‘타키’와 ‘미츠하’ 언제부턴가 더 이상 몸이 바뀌지 않자 자신들이 특별하게 이어져있었음을 깨달은 ‘타키’는 ‘미츠하’를 만나러 가는데... 잊고 싶지 않은 사람 잊으면 안 되는 사람 너의 이름은?","2023-02-21","해외","12"),
("애니메이션",null,"드래곤 길들이기2","2014-07-23","101분","바이킹과 드래곤이 친구가 되어 평화롭게 살아가는 버크섬. 청년이 된 히컵은 아버지 스토이크의 바람과는 달리 족장이 되는 것 보다 버크섬 밖의 더 넓은 세상을 보고 싶어한다. 그러던 어느 날, 신비로운 얼음대륙을 탐험하던 히컵과 투슬리스는 드래곤 사냥꾼들이 쳐놓은 덫에 걸리고, 드래곤들을 위협하는 강력한 어둠의 존재에 대해 알게 된다. 히컵과 투슬리스는 드래곤들의 평화를 위해 의문의 드래곤 군단과 맞서기로 결심하는데…","2023-03-21","해외","0"),
("애니메이션",null,"인사이드 아웃","2015-07-09","102분","모든 사람의 머릿속에 존재하는 감정 컨트롤 본부 그곳에서 불철주야 열심히 일하는 기쁨, 슬픔, 버럭, 까칠, 소심 다섯 감정들. 이사 후 새로운 환경에 적응해야 하는 ‘라일리’를 위해 그 어느 때 보다 바쁘게 감정의 신호를 보내지만 우연한 실수로 ‘기쁨’과 ‘슬픔’이 본부를 이탈하게 되자 '라일리’의 마음 속에 큰 변화가 찾아온다. '라일리'가 예전의 모습을 되찾기 위해서는 ‘기쁨’과 ‘슬픔’이 본부로 돌아가야만 한다! 그러나 엄청난 기억들이 저장되어 있는 머릿속 세계에서 본부까지 가는 길은 험난하기만 한데… 과연, ‘라일리’는 다시 행복해질 수 있을까? 지금 당신의 머릿속에서 벌어지는 놀라운 일! 하루에도 몇번씩 변하는 감정의 비밀이 밝혀진다!","2023-04-02","해외","0"),
("애니메이션",null,"주토피아","2016-02-17","108분","누구나 살고 싶은 도시 1위, 주토피아 연쇄 실종 사건 발생! “미치도록 잡고 싶었다!” 교양 있고 세련된 라이프 스타일을 주도하는 도시 주토피아. 이 곳을 단숨에 혼란에 빠트린 연쇄 실종사건이 발생한다! 주토피아 최초의 토끼 경찰관 주디 홉스는 48시간 안에 사건 해결을 지시 받자 뻔뻔한 사기꾼 여우 닉 와일드에게 협동 수사를 제안하는데… 스릴 넘치는 추격전의 신세계가 열린다!","2023-03-04","해외","0"),
("애니메이션",null,"빅 히어로","2015-01-21","108분","천재 공학도 ‘테디’가 개발한 힐링로봇 ‘베이맥스’! ‘테디’의 동생이자 로봇 전문가인 ‘히로’는 도시가 파괴될 위기에 처하자 ‘베이맥스’를 슈퍼히어로로 업그레이드 하는데… 과연 이들은 도시의 위험을 막아낼 수 있을까?","2023-04-20","해외","0"),
("애니메이션",null,"겨울왕국","2014-01-16","108분","서로가 최고의 친구였던 자매 ‘엘사’와 ‘안나’. 하지만 언니 ‘엘사’에게는 하나뿐인 동생에게조차 말 못할 비밀이 있다. 모든 것을 얼려버리는 신비로운 힘이 바로 그것. ‘엘사’는 통제할 수 없는 자신의 힘이 두려워 왕국을 떠나고, 얼어버린 왕국의 저주를 풀기 위해 ‘안나’는 언니를 찾아 환상적인 여정을 떠나는데……","2023-05-17","해외","0"),
("애니메이션",null,"겨울왕국2","2019-11-21","103분","어느 날 부턴가 의문의 목소리가 엘사를 부르고, 평화로운 아렌델 왕국을 위협한다. 트롤은 모든 것은 과거에서 시작되었음을 알려주며 엘사의 힘의 비밀과 진실을 찾아 떠나야한다고 조언한다. 위험에 빠진 아렌델 왕국을 구해야만 하는 엘사와 안나는 숨겨진 과거의 진실을 찾아 크리스토프, 올라프 그리고 스벤과 함께 위험천만한 놀라운 모험을 떠나게 된다. 자신의 힘을 두려워했던 엘사는 이제 이 모험을 헤쳐나가기에 자신의 힘이 충분하다고 믿어야만 하는데… 두려움을 깨고 새로운 운명을 만나다!","2023-06-18","해외","0"),
("애니메이션",null,"레드슈즈","2019-07-25","92분","사건 사고가 끊이지 않는 동화의 섬. 사라진 아빠를 찾던 화이트 왕국의 공주는 우연히 마법구두를 신고 이전과 완벽하게 다른 ‘레드슈즈’로 거듭난다. 한편, 초록색 난쟁이가 된 일곱 왕자들은 우연히 자신들의 집에 머물게 된 '레드슈즈’가 저주를 풀 유일한 희망이라 생각해 그녀를 돕기 시작하고, 영원한 아름다움을 꿈꾸는 왕비 ‘레지나’는 마법구두를 신고 성을 빠져나간 ‘레드슈즈’를 쫓기 시작하는데… 위기에 빠진 동화의 섬, 레드슈즈, 그리고 일곱 왕자들의 운명은?","2023-02-19","국내","0"),
("애니메이션",null,"날씨의 아이","2019-10-30","112분","비가 그치지 않던 어느 여름날, 가출 소년 ‘호다카’는 수상한 잡지사에 취직하게 되고 비밀스러운 소녀 ‘히나’를 우연히 만난다. “지금부터 하늘이 맑아질 거야” 그녀의 기도에 거짓말 같이 빗줄기는 멈추고, 사람들의 얼굴에 환한 빛이 내려온다. “신기해, 날씨 하나에 사람들의 감정이 이렇게나 움직이다니” 하지만, 맑음 뒤 흐림이 찾아오듯 두 사람은 엄청난 세계의 비밀을 마주하게 되는데… 흐리기만 했던 세상이 빛나기 시작했고, 그 끝에는 네가 있었다.","2023-03-07","해외","0"),
("드라마","박해일,탕웨이,이정현","헤어질 결심","2022-06-29","138분","산 정상에서 추락한 한 남자의 변사 사건. 담당 형사 '해준'(박해일)은 사망자의 아내 '서래'(탕웨이)와 마주하게 된다. '산에 가서 안 오면 걱정했어요, 마침내 죽을까 봐.' 남편의 죽음 앞에서 특별한 동요를 보이지 않는 '서래'. 경찰은 보통의 유가족과는 다른 '서래'를 용의선상에 올린다. '해준'은 사건 당일의 알리바이 탐문과 신문, 잠복수사를 통해 '서래'를 알아가면서 그녀에 대한 관심이 점점 커져가는 것을 느낀다. 한편, 좀처럼 속을 짐작하기 어려운 '서래'는 상대가 자신을 의심한다는 것을 알면서도 조금의 망설임도 없이 '해준'을 대하는데…. 진심을 숨기는 용의자 용의자에게 의심과 관심을 동시에 느끼는 형사 그들의 <헤어질 결심>","2023-04-09","국내","15"),
("드라마","송강호,강동원,배두나,아이유","브로커","2022-06-28","129분","세탁소를 운영하지만 늘 빚에 시달리는 ‘상현’(송강호)과 베이비 박스 시설에서 일하는 보육원 출신의 ‘동수’(강동원). 거센 비가 내리는 어느 날 밤, 그들은 베이비 박스에 놓인 한 아기를 몰래 데려간다. 하지만 이튿날, 생각지 못하게 엄마 ‘소영’(이지은)이 아기 ‘우성’을 찾으러 돌아온다. 아기가 사라진 것을 안 소영이 경찰에 신고하려 하자 솔직하게 털어놓는 두 사람. 우성이를 잘 키울 적임자를 찾아 주기 위해서 그랬다는 변명이 기가 막히지만 소영은 우성이의 새 부모를 찾는 여정에 상현, 동수와 함께하기로 한다. 한편 이 모든 과정을 지켜본 형사 ‘수진’(배두나)과 후배 ‘이형사’(이주영). 이들을 현행범으로 잡고 반 년째 이어온 수사를 마무리하기 위해 조용히 뒤를 쫓는다. 베이비 박스, 그곳에서 의도치 않게 만난 이들의 예기치 못한 특별한 여정이 시작된다.","2023-05-15","국내","12"),
("드라마","김유정,변우석,박정우,노윤서","20세기 소녀","2022-10-21","119분","1999년, 사랑보다 우정이 더 중요한 17세 소녀 ‘보라’(김유정)에게 일생일대 가장 중요한 숙제가 생겼다. 심장수술을 위해 외국으로 떠나는 ‘연두’(노윤서)를 대신해 첫사랑을 관찰해 소식을 전해주는 것. “이름은 백현진! 키는 181cm, 발사이즈 280mm, 좋아하는 운동은 농구… 그리고 매일 붙어다니는 친구가 한 명 있어” ‘백현진’(박정우)에 대한 정보를 알아내기 위해 절친 ‘풍운호’(변우석)를 집중공략하기 시작하는 ‘보라’. 하지만 모든 것이 계획대로 움직이지 않고, ‘보라’에게도 예상치 못한 두근거림이 찾아오는데…","2023-08-31","국내","19"),
("드라마","이정재,정우성,전혜진,허성태","헌트","2022-08-10","125분","[조직 내 숨어든 스파이를 색출하라! ‘사냥꾼’이 될 것인가, ‘사냥감’이 될 것인가!] 망명을 신청한 북한 고위 관리를 통해 정보를 입수한 안기부 해외팀 ‘박평호’(이정재)와 국내팀 ‘김정도’(정우성)는 조직 내 숨어든 스파이 ‘동림’ 색출 작전을 시작한다. 스파이를 통해 일급 기밀사항들이 유출되어 위기를 맞게 되자 날 선 대립과 경쟁 속, 해외팀과 국내팀은 상대를 용의선상에 올려두고 조사에 박차를 가한다. 찾아내지 못하면 스파이로 지목이 될 위기의 상황, 서로를 향해 맹렬한 추적을 펼치던 ‘박평호’와 ‘김정도’는 감춰진 실체에 다가서게 되고, 마침내 ‘대한민국 1호 암살 작전’이라는 거대한 사건과 직면하게 되는데…… 하나의 목표, 두 개의 총구 의심과 경계 속 두 남자의 신념을 건 작전이 시작된다","2023-05-12","국내","15"),
("드라마","다코타 존슨,코스모 자비스,니키 아무카 버드","설득","2022-07-15","109분","앤은 미천한 출신의 근사한 남자를 사랑했지만, 주변의 설득에 넘어가 그와의 결혼을 포기했다. 그로부터 8년이 지나 다시 만난 두 사람. 앤은 이번에야말로 진정한 사랑을 얻을 수 있을까?","2023-07-09","해외","0"),
("드라마","조세핀 랭포드,히어로 파인즈 티핀","에프터: 에버해피","2022-09-21","95분","런던에서 삶을 송두리째 뒤흔들 엄청난 과거를 알게 된 하딘은 자신의 불행 속에 테사를 끌어들이기 싫어서 애써 밀어낸다. 계속 제자리만 맴도는 관계에 지친 테사는 새로운 삶을 꿈꾸며 뉴욕으로 향하고, 떨어진 동안 그의 소중함을 깨달은 하딘은 뉴욕에서 테사와 재회하여 서로의 숨결과 살결을 탐한다. 다시 미래를 꿈꾸던 테사는 하딘이 집필한 소설 ‘애프터’에 자신의 첫 키스부터 첫 경험뿐만 아니라 감추고 싶던 아픈 기억까지 모두 담겨 있다는 것을 알고 충격을 받는데…","2023-06-27","해외","15"),
("드라마","로버트 드 니로,샤론 스톤,조 패시,제임스 우즈","카지노","1996-03-16","178분","에이스는 도박이라는 모든 도박에 내기를 걸면 언제나 이기는 재주를 타고 났다.조그만 동네에서 자란 그는 그런 재주 때문에 마피아 보스들에게 알려진다. 또한 그들의 성질을 잘 아는 에이스는 자기가 벌어들인 모든 돈의 내역을 보스들에게 일일이 보고한다. 마피아 보스들이 그런 에이스를 아껴 그를 보호하기 위해 니키를 붙여준다. 니키는 비록 몸집은 작지만 상대가 얼마나 크든지간에 먼저 제압해 버리는 능력을 갖고 있는 갱이다.오랫동안 니키와 에이스는 완벽한 팀을 이루게 된다.그러나 라스베가스로 진출한 에이스는 니키의의 포악한 성질이 걱정돼 니키가 라스베가스로 온다는 소식을 접하고 웬지 꺼려 한다. 그런 에이스의 심정을 눈치채고 있던 니키는 라스베가스에서 자신의 독특한 방법인 폭력으로 나름대로의 영역을 넓혀나가고, 에이스는 합법적인 카지노를 운영하면서 고향의 보스들을 챙기는 걸 잊지 않으면서 자신의 입지를 굳혀 가는데...","2024-01-01","해외","19"),
("드라마","케네스 브래너,페널로페 크루즈,윌렘 대포","오리엔트 특급 살인","2017-11-29","114분","세계적 명탐정 ‘에르큘 포와로’(케네스 브래너)는 사건 의뢰를 받고 이스탄불에서 런던으로 향하는 초호화 열차인 오리엔트 특급열차에 탑승한다. 폭설로 열차가 멈춰선 밤, 승객 한 명이 잔인하게 살해당하는 사건이 발생하게 된다. 기차 안에서 벌어진 밀실 살인, 완벽한 알리바이를 가진 13명의 용의자. 포와로는 현장에 남겨진 단서와 용의자들의 증언을 토대로 미궁에 빠진 사건 속 진실을 찾기 위한 추리를 시작하게 되는데…","2023-05-05","해외","12"),
("드라마","수라스 샤르마,이르판 칸","라이프 오브 파이","2013-01-01","127분","인도에서 동물원을 운영하던 ‘파이’의 가족은 동물들을 싣고 이민을 떠나는 도중 거센 폭풍우를 만나고 배는 침몰한다. 혼자 살아남은 파이는 가까스로 구명보트에 올라 타지만 다친 얼룩말과 굶주린 하이에나, 그리고 오랑우탄과 함께 표류하게 된다. 하지만 모두를 놀라게 만든 진짜 주인공은 바로 보트 아래에 몸을 숨기고 있던 벵골 호랑이 ‘리처드 파커’! 배고픔에 허덕이는 동물들은 서로를 공격하고 결국 파이와 리처드 파커만이 배에 남게 되는데… 끝없이 펼쳐진 수평선, 거대하게 빛나는 고래 바다를 빛으로 물들인 해파리, 미어캣이 사는 신비의 섬까지, 파이와 리처드 파커 앞에 그 누구도 보지 않고서는 믿을 수 없는 놀라운 광경이 펼쳐진다!","2023-05-29","해외","0"),
("드라마","레오나르도 디카프리오, 톰 하디","레버넌트: 죽음에서 돌아온 자","2016-01-14","156분","서부 개척시대 이전인 19기 아메리카 대륙, 사냥꾼인 휴 글래스(레오나르도 디카프리오)는 아들 호크를 데리고 동료들과 함께 사냥하던 중 회색곰에게 습격 당해 사지가 찢긴다. 비정한 동료 존 피츠 제럴드(톰 하디)는 아직 살아 있는 휴를 죽이려 하고, 아들 호크가 이에 저항하자 호크 마저 죽인 채 숨이 붙어 있는 휴를 땅에 묻고 떠난다. 눈 앞에서 하나뿐인 아들의 죽음을 목격한 휴는 처절한 복수를 위해 부상 입은 몸으로 존의 뒤를 쫓기 시작하는데….","2023-04-14","해외","15")
,

("범죄", "채드윅 보스만, 시에나 밀러", "21 브릿지 테러 셧다운", "2020-01-01", "99분",
...
"2023-04-27","해외","15"),
("범죄","조엘 킨나만, 클라이브 오웬","비밀정보원 인 더 프리즌","2020-04-15","113분",
...
"2023-01-27","해외","19"),
("범죄","키아누 리브스","존 윅 3 파라벨룸","2019-06-26","131분",
...
"2023-02-23","해외","19"),
("범죄","스코트 스피드먼, 리브  타일러","노크 낯선 자들의 방문",
"2008-07-02","85분",
...
"2023-08-23","해외","15"),
("범죄","아놀드 슈왈제네거, 실베스터 스탤론","이스케이프 플랜","2013-12-05","115분",
...
"2023-09-05","해외","19"),
("범죄","마동석, 손석구","범죄도시2","2022-05-18","106분",
...
"2023-09-06","국내","15"),
("범죄","최민식, 하정우","범죄와의전쟁","2012-02-02","133분",
...
박성배의 수하로 들여보내고, 살아남기 위해 혈안이 된 나쁜 놈들 사이에서 서로 물지 않으면 물리는 지옥도가 펼쳐진다.","2023-12-25","국내","19"),
...
"2023-09-12","국내","15"),
("코미디","유해진, 황우슬혜","레슬러","2018-05-09","110분",
...
"2023-09-13","국내","15"),
("코미디","이성민, 신하균","미스터 주","2020-01-22","113분",
...
"2023-09-14","국내","12"),
("코미디","심은경, 나문희","수상한 그녀","2014-01-22","124분",
...
"2023-09-18","해외","19"),
("코미디","짐 캐리, 주이 디샤넬","예스맨","2008-12-17","104분",
...
"2023-09-19","해외","15"),
("코미디","채닝 테이텀","도그","2022-10-26","101분",
"이라크 파병으로 후유증으로 부대복귀가 불가능한 특수부대 출신 미군 ‘잭슨’. 어느 날, 그의 동료의 사망소식을 듣고, 그의 군견 ‘룰루’ 를 2400km나 떨어진 그의 장례식장에 데려가면 복직을 추천해주겠다는 상관의 제안을 받는다. 잭슨은 이를 수락하지만, 룰루 또한 이미 전투후유증으로 사나운 사고뭉치가 되어있었다. 잭슨과 룰루는 서로에 대한 마음도 열지 못한 채 둘 만의 여정을 떠나게 되는데…
 
 둘은 다사다난하고 다이내믹한 여정을 무사히 마칠 수 있을까?","2023-05-30","해외","12"),
("역사","최민식, 류승룡","명량","2014-07-30","128분",
...
"2023-09-20","국내","15"),
("역사","송강호, 유해진","택시운전사","2017-08-02","137분",
...
"2023-09-21","국내","15"),
("역사","이정재, 리암 니슨","인천상륙작전","2016-07-27","110분",
...
"2023-09-22","국내","12"),
("역사","송강호, 오달수","변호인","2013-12-18","127분",
...
"2023-09-23","국내","15"),
("역사","황정민, 오달수","국제시장","2014-12-17","126분",
...
"2023-09-24","국내","12"),
("역사","베네딕트 컴버배치, 키이라 나이틀리","이미테이션 게임","2015-02-17","114분",
...
"2023-09-25","해외","15"),
("역사","핀 화이트헤드, 톰 하디","덩케르크","2017-07-20","106분",
...
"2023-09-26","해외","12"),
("역사","브래드 피트, 로건 레먼","퓨리","2014-11-20","134분",
...
"2023-09-27","해외","15"),
("역사","휴 잭맨, 앤 헤서웨이","레미제라블","2012-12-19","158분",
...
"2023-09-28","해외","12"),
("역사","다니엘 데이 루이스, 조셉 고든 레빗","링컨","2013-03-14","150분",
...
("스릴러","김윤석, 하정우","추격자","2008-02-14","123분","출장안마소(보도방)를 운영하는 전직 형사 ‘중호’, 최근 데리고 있던 여자들이 잇달아 사라지는 일이 발생하고, 
조금 전 나간 미진을 불러낸 손님의 전화 번호와 사라진 여자들이 마지막으로 통화한 번호가 일치함을 알아낸다. 하지만 미진 마저도 연락이 두절되고…… 미진을 찾아 헤매던 중 우연히 ‘영민’과 마주친 중호, 옷에 묻은 피를 보고 영민이 바로 그놈인 것을
 직감하고 추격 끝에 그를 붙잡는다.",
"2024-02-23","국내","19"),
("스릴러","베라 파미가, 패트릭 윌슨","컨저링1","2013-09-17","112분","1971년 로드 아일랜드, 해리스빌. 페론 가족은 꿈에 그리던 새 집으로 이사를 간다. 물론 1863년에 그 집에서 일어난 끔찍한 살인 사건을 전혀 몰랐다. 또한 
그 이후에 일어난 많은 무서운 사건에 대해서도 알지 못했다.",
"2024-07-23","해외","15"),
("스릴러","제임스 맥어보이, 안야 테일러 조이","23 아이덴티티","2017-02-22","134분","23개의 
인격을 가진 남자 ‘케빈’(제임스 맥어보이). 그는 언제 누가 등장할지 모르는 인격들 사이를 오가며 유일하게 자신을 이해하는 ‘플레처’ 박사(베티 버클리)에게만 자신의 이야기를 꺼내 놓는다.",
"2029-05-12","해외","15"),
("스릴러","제임스 맥어보이, 안야 테일러 조이","컨저링2","2016-06-09","134분","1977년 영국 엔필드. 엄마 페기와 네 남매가 살고 있는 가족의 집에 정체를 알 수 없는 존재가 나타난다. 일명 폴터가이스트 유령. 벽을 두드리는
 소리, 사악한 목소리, 유령은 밤마다 가구와 물건들, 심지어 아이들까지 공중에 띄우는 등 기이한 일들을 일으킨다.",
"2029-05-12","해외","15"),
("스릴러","제임스 맥어보이, 안야 테일러 조이","컨저링3","2021-06-03","111분","1981년, 미국 역사상 최초로 잔혹한 살인사건의 용의자가 악마가 살해하도록 시켰다고 주장하는 초유의 사태가 일어난다! 그리고 사건의 배후에는
 악마에게 빙의된 소년이 있었는데… 초자연 현상 연구가 워렌 부부의 사건 파일 중 여전히 미스터리로 남아있는 실화! 진실 혹은 거짓? 살인사건의 범인, 인간인가 악마인가...",
"2024-07-25","해외","15"),
("스릴러","이선균, 조진웅","끝까지 간다","2014-05-29","111분","어머니의 장례식 날, 급한 연락을 받고 경찰서로 향하던 형사 ‘고건수’(이선균). 아내의 이혼 통보, 갑작스런 내사 소식까지, 스트레스 폭발 직전의 건수는 실수로
...
"2029-02-08","국내","15"),
("스릴러","손현주.문정희.전미선","숨바꼭질","2013-08-14","107분","우리 집에 낯선 사람이 숨어 살고 있다면...? 숨바꼭질 암호 □1○1△2 고급 아파트에서 완벽한 가정을 꾸리고 사는 성공한 사업가 ‘성수’(손현주)는
...
("스릴러","강하늘,김무열","기억의 밤","2017-11-29","109분","새 집으로 이사 온 날 밤 정체불명의 괴한들에게 납치된 형 유석. 동생 진석은 형이 납치된 후 매일 밤 환청과 환각에 시달리며 불안해한다. 납치된지 19일째 되는 
...
("스릴러","이병헌,최민식","악마를 보았다","2010-08-12","144분","국정원 경호요원 ‘수현(이병헌)’은 약혼녀 주연이 잔인하게 살해당하자 자신에게 가장 소중한 사람을 지켜내지 못했다는 자괴감과 분노로 가장 고통스러운 복수를 다짐한다. 수현은 연쇄살인마 ‘장경철(최민식)’이 범인임을 알아내고 죽을 만큼의 고
통만 가하고 놓아주기를 반복하며 처절한 응징을 시작한다. 그러나, 악마보다 더 악랄한 살인마 장경철은 난생 처음 만난 대등한 적수의 출현을 즐기며 반격에 나서기 시작하는데…",
"2023-12-25","국내","19"),

("스릴러","브래드 피트,미레유 에노스","월드워z","2013-06-20","115분","전 세계 이상 기류… 거대
...
조사관 제리는 위험한 상황에서 가까스로 가족들과 탈출하는데 성공하고 이제껏 본적 없는 인류 최대의 위기 앞에 대재난에
 ...
 인류 최후의 대재난을 막아낼 수 있을 것인가!","2028-02-01","해외","15"),
