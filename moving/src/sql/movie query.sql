...
moviecontents,movieended,national,agelimit) values(
...
궁지에 몰린 MI6조차 그를 포기하면서 절체절명의 위기에 직면하는데…","2023-01-21","해외","15세"),
...
"전 세계가 목격한 사상 최악의 테러 발생 15일 후, '미치(크리스 헴스워스)'는 사랑하는 가족을 뒤로 한 채 비공식 작전 수행을 위한
 ...
 그러나 반드시 성공해야만 하는 작전!","2023-02-24","해외","15세"),
 ...
 각자의 목적으로 뭉친 그들의 짜릿한 공조 수사가 시작된다!","2023-03-31","국내","15세"),
...
새로운 사건이 발생하고 데드풀은 생각지도 못한 기상천외 패밀리를 결성하게 되는데...","2023-06-25","해외","19세"),
...
매버릭은 자신이 가르친 동료들과 함께 마지막이 될 지 모를 하늘 위 비행에 나서는데…","2024-03-30","해외","12세"),
...
"도난당한 핵무기를 되찾아 오는 위험천만한 작전 중, 에단 헌트(톰 크루즈)는 임무를 포기하고, 팀원의 목숨을 구하는 선택을 한다.
 ...
 이보다 더 불가능한 미션은 없었다!
 역대 최대 규모, 최강 액션을 기대하라!","2022-02-23","해외","15세"),
...
진실을 위해서라면 몸을 사리지 않는 정의로운 열혈 기자 '에디 브록'
 ...
 지배할 것인가, 지배당할 것인가","2023-01-31","해외","15세"),
 ...
 세상을 구할 히어로 ‘블랙 팬서’로서 피할 수 없는 전쟁에 나서는데…","2023-02-22","해외","12세"),
...
과거의 기억으로 마음을 닫아버린 남자 '루이'
 ...
 눈을 감으면 더욱 선명해지는 얼굴,
 너의 눈이 말하고 있어.","2022-03-11","해외","15세"),
...
평범한 대학 신입생 델마는 우연히 아냐를 만난 후 발작으로 쓰러진다
 ...
 WANT HER WAKE HER","2023-01-02","해외","15세"),
...
XP(색소성건피증)라는 희귀병으로 태양을 피해야만 하는 케이티.
 ...
 너에게 하고 싶은 진짜 사랑 고백
 태양이 뜬 뒤에도 내 곁에 있어줄래?","2023-02-20","해외","12세"),
...
친구도, 가족도, 사랑도 없는 외로운 중년 여성 세츠코.
 ...
 세츠코는 과연 진짜 사랑을 붙잡을 수 있을까?","2023-05-31","해외","15세"),
...
사랑을 믿지 않는 간호사, 펠리시아
 ...
 각국의 전쟁지로 떠도는 그로 인해
 혼란과 외로움으로 밤을 지새우는데…","2023-04-20","해외","19세"),
 ...
 사랑하는 아내를 지키려는 카이펑. 그러나 두 사람은 생각지도 못했던 비밀을 마주하게 되는데….","2023-04-02","해외","15세"),
...
12년 내내 여학교를 다니며 학생대표를 해오던 윙(담선언),
 ...
 평생 함께하자던 소울메이트였던 그들,
 그때 너도 나와 같은 마음이었을까?","2023-05-04","해외","15세"),
...
누구나 품을 수 있지만, 누구도 소유할 수 없는 ‘엔젤’
 ...
 사랑이 이끄는 순간, 눈부신 기적이 시작된다!","2024-02-11","해외","15세"),
...
슈퍼스타 ‘캣 발데즈’는 화려한 공개 결혼식 콘서트 당일
 ...
 두 사람의 특별한 선결혼 후연애 로맨스가 지금부터 시작된다!","2024-01-10","해외","12세"),
...
사랑과 관계에 서툰 ‘에이프릴’은
 ...
 짝, 사랑
 환상 속에 그대는 지금 어디에 있나요?","2023-08-31","해외","12세"),
...
옛날 어느 먼 옛날, 그레텔과 헨젤은 먹을 것과 일감을 찾기 위해 집을 떠나지만 길을 잃고 만다. 그들은 허기짐에 먹을 것이 풍성하게 차려진 한 오두막에 이끌려 집으로 들어가게 되고, 그 곳에서 집 주인 ‘홀다’를 만난다. 그녀의 배려로 두 남매는 풍족한 음식과 따뜻한 잠자리를 제공받으며 점점 안정을 되찾는다.
 ...
 두 남매를 계속해서 어둠 속으로 몰아넣는데…","2023-07-20","해외","15세"),
 ...
 남겨진 고스트는 영원히 그녀를 기다릴 자신의 운명을 알기에 끝을 알 수 없는 긴 여정을 시작한다","2023-12-20","해외","12세"),
...
자신의 특별한 능력을 통해 사람들의 마음 속 슬픔과 갈망을 들여다보는 최면술사 ‘제니아’.
 ...
 '당신의 불행과 고통을 몰아내는 중입니다. 제가 셋을 세면 눈을 뜹니다. 하나, 둘, 셋, 탁!'","2023-11-11","해외","15세"),
...
‘필립 왕자’의 결혼 약속으로 인간 세계의 ‘잉그리스 왕비’와 대립하게 된다.
 ...
 등장하면서 두 세계는 피할 수 없는 거대한 전쟁에 휘말리게 되는데…..","2023-01-20","해외","12세"),
...
2015년 현재
 ...
 그 때로 돌아간다면… 지금의 내 인생도 바뀔 수 있을까요?","2024-04-02","국내","12세"),
...
할아버지의 죽음의 단서를 쫒던 ‘제이크’ 는 시간의 문을 통과해 놀라운 비밀과 마주한다.
 ...
 시간과 공간을 넘나들며 펼쳐지는 이들의 대결이 팀버튼의 마법같은 상상력으로 펼쳐진다.","2023-05-01","해외","12세"),
...
택해야 한다. 마침내 다섯 군대의 전투가 시작되고 빌보는 본인과 친구들의 목숨을 걸고 싸워야만 하는데…","2023-02-15","해외","12세"),
...
모킹제이가 되어달라고 부탁하고, 모두의 희망이 된 캣니스는 이제 세상을 구할 반격을 시작한다.","2023-03-20","해외","15세"),
...
할로윈이 다가오고 있던 어느 날, 단짝 ‘소니’와 ‘샘’은 으스스한 분위기의 버려진 집을 발견한다.
 ...
 위험에 빠진 가족과 마을을 구할 수 있을까?","2023-06-30","해외","12세"),
 ...
 이승과 저승, 현재와 과거를 오가는 천 년의 비밀이 밝혀진다!","2023-03-09","국내","12세"),
...
"2023-09-09","국내","19세"),
("범죄","정우성, 황정민","아수라","2016-09-28","132분",
...
각자의 이익과 목적을 위해 한도경의 목을 짓누르는 검찰과 박성배. 그 사이 태풍의 눈처럼 되어 버린 한도경은, 자신을 친형처럼 따르는 후배 형사 문선모(주지훈)를 
박성배의 수하로 들여보내고, 살아남기 위해 혈안이 된 나쁜 놈들 사이에서 서로 물지 않으면 물리는 지옥도가 펼쳐진다.","2023-12-25","국내","19세"),
...
"2023-08-11","해외","12세"),
("SF","마크월버그","트랜스포머","2007-06-28","145분",
...
"2023-08-15","해외","15세"),
("SF","리즈","생존: 두개의세계","2019-08-21","125분",
...
"2023-08-18","국내","15세"),
("SF","크리스탈","400데이즈","2015-11-12","142분",
...
"2023-08-19","해외","15세"),
("SF","매튜 맥커너히, 앤 해서웨이","인터스텔라","2014-11-06","169분",
